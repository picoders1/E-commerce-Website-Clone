...
# Example of a e-commece website
![image](https://github.com/user-attachments/assets/2855d418-2ea4-456f-a55f-83ea45d3caa5)
# Example of a e-commece website code
```
    ...
    <!-- 
     ...
     <!-- 
      ...
      <!-- 
       ...
       <link rel="preload" as="image" href="./assets/hero-banner-1.jpg">
       <link rel="preload" as="image" href="./assets/hero-banner-2.jpg">
       <link rel="preload" as="image" href="./assets/hero-banner-3.jpg">  
     ...
     <header class="header">
        ...
        <div class="header-top" data-header>
            <div class="container">
                ...
                <a href="#" class="logo">
                    <img src="./assets/logo.png" width="179" height="26" alt="Glowing">
                </a>
                ...
                <div class="container">
                    ...
                    <ul class="has-scrollbar">
                        ...
                        <li class="scrollbar-item">
                            <div class="hero-card has-bg-image" style="background-image: url('./assets/hero-banner-1.jpg');">
                        ...
                        <li class="scrollbar-item">
                            <div class="hero-card has-bg-image" style="background-image: url('./assets/hero-banner-2.jpg');">
                        ...
                        <li class="scrollbar-item">
                            <div class="hero-card has-bg-image" style="background-image: url('./assets/hero-banner-3.jpg');">
                        ...
                        <ul class="collection-list">
                            ...
                            <li>
                                <div class="collection-card has-before hover:shine">
                                    ...
                                    <div class="has-bg-image" style="background-image: url(./assets/collection-1.jpg);"></div>
                            ...
                            <li>
                                <div class="collection-card has-before hover:shine">
                                    ...
                                    <div class="has-bg-image" style="background-image: url(./assets/collection-2.jpg);"></div>
                            ...
                            <li>
                                <div class="collection-card has-before hover:shine">
                                    ...
                                    <div class="has-bg-image" style="background-image: url(./assets/collection-3.jpg);"></div>
                        ...
                        <ul class="has-scrollbar">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-01.jpg" width="540" height="720" loading="lazy" 
                                        ...
                                        <div class="card-actions">
                                            ...
                                            <button class="action-btn" aria-label="add to whislist">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-02.jpg" width="540" height="720" loading="lazy" 
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-03.jpg" width="540" height="720" loading="lazy" 
                                        alt="Coffe Bean Caffeine Eye Cream" class="img-cover">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <h3>
                                            <a href="#" class="card-title">Coffe Bean Caffeine Eye Cream</a>
                                        </h3>
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-04.jpg" width="540" height="720" loading="lazy" 
                                        alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-05.jpg" width="540" height="720" loading="lazy" 
                                        alt="Coffe Bean Caffeine Eye Cream" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-06.jpg" width="540" height="720" loading="lazy" 
                                        alt="Facial cleanser" class="img-cover">
                        ...
                        <ul class="has-scrollbar">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-07.jpg" width="540" height="720" loading="lazy" 
                                        alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-08.jpg" width="540" height="720" loading="lazy" 
                                        alt="Bio-shroom Rejuvenating Serum" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-09.jpg" width="540" height="720" loading="lazy" 
                                        alt="Coffe Bean Caffeine Eye Cream" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-10.jpg" width="540" height="720" loading="lazy" 
                                        alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/product-11.jpg" width="540" height="720" loading="lazy" 
                                        alt="Coffe Bean Caffeine Eye Cream" class="img-cover">
                        ...
                        <ul class="banner-list">
                            ...
                            <li>
                                <div class="banner-card banner-card-1 has-before hover:shine">
                                   ...
                                   <div class="has-bg-image" style="background-image: url(./assets/banner-1.jpg);"></div>
                            ...
                            <li>
                                <div class="banner-card banner-card-2 has-before hover:shine">
                                    ...
                                    <p class="card-text">
                                        Makeup with extend range in colors for every human.                                        
                                    </p>

                                   <a href="#" class="btn btn-secondary">Shop Sale</a>

                                   <div class="has-bg-image" style="background-image: url(./assets/banner-2.jpg);"></div>
                        ...
                        <ul class="flex-list">
                            ...
                            <li class="flex-item">
                                <div class="feature-card">
                                    ...
                                    <img src="./assets/feature-1.jpg" width="204" height="236" loading="lazy" alt="Guaranteed PURE" 
                                    class="card-icon">
                            ...
                            <li class="flex-item">
                                <div class="feature-card">
                                    ...
                                    <img src="./assets/feature-2.jpg" width="204" height="236" loading="lazy" 
                            ...
                            <li class="flex-item">
                                <div class="feature-card">
                                    ...
                                    <img src="./assets/feature-3.jpg" width="204" height="236" loading="lazy" alt="Ingredient Sourcing" 
                                    class="card-icon">
                 ...
                 <section class="section offer" id="offer" aria-label="offer" data-section>
                    <div class="container">
                        ...
                        <figure class="offer-banner">
                            <img src="./assets/offer-banner-1.jpg" width="305" height="408" alt="offer products" class="w-100">
                        </figure>

                        <figure class="offer-banner">
                            <img src="./assets/offer-banner-2.jpg" width="450" height="625" alt="offer products" class="w-100">
                        </figure>

                        <div class="offer-content">

                            <p class="offer-subtitle">
                                <span class="span">Speacial offer</span>
                        ...
                        <ul class="flex-list">
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
                                        <img src="./assets/blog-1.jpg" width="700" height="450" loading="lazy" alt="Find a store" class="img-cover">
                                    </figure>
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
                                        <img src="./assets/blog-2.jpg" width="700" height="450" loading="lazy" alt="From Our Blog" class="img-cover">
                                    </figure>
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine" style="--width: 700; --height: 450;">
                                        <img src="./assets/blog-3.jpg" width="700" height="450" loading="lazy" alt="Our Story" class="img-cover">
                                    </figure>
                 ...
                 <footer class="footer" data-section>
                    <div class="container">
                        ...
                        <div class="footer-bottom">
                            ...
                            <a href="#" class="logo">
                                <img src="./assets/logo.png" width="179" height="26" loading="lazy" alt="Glowing">
                            </a>

                            <img src="./assets/pay.png" width="313" height="28" alt="available all payment method" class="w-100">
